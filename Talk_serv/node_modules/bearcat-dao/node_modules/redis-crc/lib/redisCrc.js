...
function keyHashSlot(key, keylen, mod) {
	return crc16(key, keylen) & (mod - 1);
}

// function keyHashSlot(key, keylen, mod) {
// 	var s, e; /* start-end indexes of { and } */
...
RedisCrcService.crc16 = function(key, len) {
	return crc16(key, len);
}

RedisCrcService.keyHashSlot = function(key, len, mod) {
	return keyHashSlot(key, len, mod);
}

module.exports = RedisCrcService;