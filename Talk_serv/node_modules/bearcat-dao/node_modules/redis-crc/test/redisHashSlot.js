...
function keyHashSlot(key, len, mod) {
...
redisHash.crc16 = crc16;
redisHash.keyHashSlot = keyHashSlot;

module.exports = redisHash;
// module.exports = function(str, mod) { // Previously called redisClusterSlot
//   return (crc16(str) % mod);
// }